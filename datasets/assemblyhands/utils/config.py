...
class Config(BaseConfig):
    def __init__(self, dataset="InterHand2.6M", setup=0, pair=(0, 3)):
        super(Config, self).__init__()
        setups = [['HMC_21176875', 'HMC_21176623', 'HMC_21110305', 'HMC_21179183'],
                  ['HMC_84346135', 'HMC_84347414', 'HMC_84355350', 'HMC_84358933']]
        self.setup, self.pair = setup, pair
        self.cam_pair = [setups[self.setup][self.pair[0]], setups[self.setup][self.pair[1]]]
        ## dataset
